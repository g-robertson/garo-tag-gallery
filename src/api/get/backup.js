...
import { LocalTaggableServices, Taggables, UserFacingTaggableFiles } from "../../db/taggables.js";
...
export default async function get(dbs, req, res) {
    ...
    const userFacingTaggableFiles = await UserFacingTaggableFiles.selectManyByTaggableIDs(
        dbs,
    ...
    backup.push(...userFacingTaggableFiles.map(userFacingTaggableFile => ({
        Type: IMPORTABLE_TYPES.USER_FACING_LOCAL_FILE,
        File_Hash: userFacingTaggableFile.File_Hash,
        File_Extension: userFacingTaggableFile.File_Extension,
        Taggable_Created_Date: userFacingTaggableFile.Taggable_Created_Date,
        Taggable_Deleted_Date: userFacingTaggableFile.Taggable_Deleted_Date,
        Taggable_Last_Modified_Date: userFacingTaggableFile.Taggable_Last_Modified_Date,
        Taggable_Last_Viewed_Date: userFacingTaggableFile.Taggable_Last_Viewed_Date,
        Local_Taggable_Service_ID: userFacingTaggableFile.Local_Taggable_Service_ID,
        URL_Associations: userFacingTaggableFile.URL_Associations,
        Tags: userFacingTaggableFile.Tag_Groups.map(tagGroup => tagGroup.tags.map(tag => [
            tag.Lookup_Name,
            tag.Display_Name,
            tag.Source_Name,
            tagGroup.Namespaces,
        ...
        Metrics: userFacingTaggableFile.Metrics.map(metric => ({

...
import { applyTagFilter, beginDatabaseProcessingFiles, beginFilteringPotentialDuplicates, commitDuplicates, createNewDuplicatesProcessingPage, duplicateDiscardUncommitted, duplicateGoBack, duplicateSkip, selectTagFromLocalTagSelector, selectTagFromTagSearchQuery } from "../../../functionality/pages-functionality.js";
import { BY_DEDUPE_PREVIEW_GALLERY_IMAGE, closeModal, closePage, DEFAULT_TIMEOUT_TIME, doubleClick, findDedupePreviewGalleryImages, modClick, scroll, UNTIL_JOB_BEGIN, UNTIL_JOB_END, untilCountElementsLocated, xpathHelper } from "../../../helpers.js";
...
export const DUPLICATES_PROCESSING_PAGE_TESTS = [
    ...
    {name: "WithDuplicateProcessedFiles", tests: [
        ...
        // Need to develop an admin tool for resetting phashes
        ...
        {name: "DedupeGallery", tests: [
            ...
            {name: "DedupeGalleryShouldPromptForCommitAtEnd", tests: {
                expectedDifficulty: IMPLEMENTATION_DIFFICULTIES.UNDER_AN_HOUR,
                priority: BUG_PRIORITIES.NEXT_WORK,
                impact: BUG_IMPACTS.UNUSABLE,
                noticeability: BUG_NOTICES.MAJOR
            ...
            {name: "DedupeGalleryScrollShouldSwitchActiveFile", tests: async (driver) => {
                ...
                const src = driver.findElement()
                await scroll(driver, )

                await commitDuplicates(driver);
            }},
            {name: "DedupeGalleryArrowKeysShouldSwitchActiveFile", tests: {
                expectedDifficulty: IMPLEMENTATION_DIFFICULTIES.UNDER_AN_HOUR,
                priority: BUG_PRIORITIES.CURRENT_WORK,
                impact: BUG_IMPACTS.ASSUMED_WORKING,
                noticeability: BUG_NOTICES.ASSUMED_WORKING
            }},
            {name: "DedupeGalleryUncommittedDiscardShouldNotCauseIndexToMove", tests: {
                expectedDifficulty: IMPLEMENTATION_DIFFICULTIES.UNDER_AN_HOUR,
                priority: BUG_PRIORITIES.INTEND_FOR_THIS_RELEASE,
